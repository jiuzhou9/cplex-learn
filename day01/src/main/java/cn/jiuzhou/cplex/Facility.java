 ...
 *       open[j] in {0, 1}
 * </code>
 * For further details see the {@link usage()} function.
 */
public class Facility {
    ...
    * {@link capacity}, {@link fixedCost}, {@link cost}, {@link nbLocations},
    * and {@link nbClients} fields.
   ...
   private static enum BendersType { NO_BENDERS, AUTO_BENDERS, ANNO_BENDERS };
   ...
   public static void main(String[] args) {
      try {
         ...
         case ANNO_BENDERS:
            ...
            IloCplex.LongAnnotation decomp =
